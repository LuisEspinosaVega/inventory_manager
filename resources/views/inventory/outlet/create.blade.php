...
@section('content')
    <div class="container">
        <h4 class="text-center">Generar salida de artículos</h4>
        <div class="row justify-content-center my-4">
            <div class="col-12 col-md-6">
                <form action="{{ route('outlet.store') }}" method="post" class="formCreate">
                    @csrf
                    ...
                    <div class="row form-group">
                        <label for="type" class="col-12 col-md-5 text-center text-md-right align-self-center"><b>TIPO DE
                                SALIDA<span class="text-danger">*</span>:</b></label>
                        <div class="col-12 col-md-7">
                    ...
                    <div class="row form-group">
                        <label for="mandated"
                            class="col-12 col-md-5 text-center text-md-right align-self-center"><b>ENCARGADO DE LA
                                SALIDA<span class="text-danger">*</span>:</b></label>
                        <div class="col-12 col-md-7">
                    ...
                    <div class="row form-group justify-content-center">
                        <div class="col-auto">
                            <button type="button" class="btn btn-sm btn-secondary" data-toggle="modal"
                                data-target="#cancelOutletModal">Cancelar salida</button>
                            {{-- <a href="{{route('entries')}}" class="btn btn-sm btn-secondary">Cancelar ingreso</a> --}}
                        </div>
                        <div class="col-auto">
                            @if (Auth::user()->can('edit_inventory'))
                                <button type="button" class="btn btn-sm btn-primary" id="btnConfirmOutlet">Confirmar
                                    salida</button>
                            @else
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="h5 text-center">Articulos para salida</div>
                <div class="row form-group">
                ...
                <form action="" id="itemsOutletForm">
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                        <div class="col-12 col-md-5 text-center text-md-right align-self-center"><b>Piezas para salida:</b>
                        </div>
                        <div class="col-12 col-md-7">
                            <input type="number" name="outlet_amount" id="outlet_amount" class="form-control">
                        </div>
                    </div>
            ...
            <div class="h5 text-center font-weight-bolder">Lista de articulos para salir</div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="cancelOutletModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-body bg-dark">
                    <div class="row justify-content-center my-3">
                        ...
                        <div class="col-auto">
                            <a href="{{ route('outlet') }}" class="btn btn-sm btn-danger">Si, cancelar</a>
                        </div>
                    </div>
                </div>
            </div>
...
@push('custom-scripts')
    ...
    <script src="{{ asset('js/outlet-create.js') }}" defer></script>
@endpush
